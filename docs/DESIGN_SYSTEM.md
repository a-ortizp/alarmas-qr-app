...
**Totales: 29 componentes · 79 estados/variantes** en L03–L07, más los complementos 31–36 (L08) y los componentes web 37–46 (L09, v1.4): 45 componentes en el archivo Figma.
...
| L08 · Complementos v1.1 | Componentes 31–36: acciones de alarma sonando, controles sobre Tinta, primario sobre amarillo, hora en tarjeta 28 + 14, tonos de texto |
...
Base estructural: **Material 3** (anatomía y métricas de los componentes: alturas 44/48/56 — **48 para toque en móvil, 44 para puntero en web** (v1.5) —, radio 14 px/píldora en tarjetas, modales y campos, área táctil 48 px) re-tematizado con la paleta "Energía puntual". Reglas transversales: amarillo solo en la acción principal; coral solo en urgencia/destrucción; sobre amarillo siempre texto Tinta (12.9:1); estados nunca comunicados solo con color (color + forma/símbolo).
...
| Altura de botones | 48 | 48 (los mockups v1 usaban 44; corregido en v1.1). Acciones de la alarma sonando: 56. |
...
| Componente | Especificación | Catálogo |
|---|---|---|
| Botón primario web | Píldora Amarillo Energía, texto Tinta Archivo SemiBold 14–15, **44 pt de alto en toda la web** (v1.5: cabecera de página, modales, W06 y tarjeta de acceso; antes 39/42/44). Regla: 48 para toque en móvil, 44 para puntero en web, ambas en la escala 44/48/56. Un solo primario por pantalla: en W01 «Exportar reporte»; «Descargar QR en lote» va en contorno. | 1 |
