...
Fecha: 2026-09-01 · **v1.14 del 2026-09-24 (solo documento: switch apagado y excepción de marca en la regla del amarillo, ver §5)** · **v1.13 del 2026-09-24 (solo documento: medidas web reales de la tarjeta de acceso y del diálogo modal, ver §5)** · **v1.12 del 2026-09-24 (solo documento: peso de las horas grandes a Black, ver §5)** · **v1.11 del 2026-09-19 (archivo Figma: sets 48 «Iconos de calendario · móvil» y 49 «Chip como control · móvil» en L08 v1.8, ver §5)** · v1.10 del 2026-09-19 (solo documento: reglas de la revisión de los tutores sobre los mockups móviles v1.7) · v1.1/v1.2 del 2026-09-08 (correcciones tras la crítica de diseño, ver §6) · **v1.3/v1.4 del 2026-09-14: componentes web tal como quedaron en los mockups de la página `03 · Web` (ver §7), construidos como lámina L09 en Figma** · **v1.6 del 2026-09-17: botones móviles a 52 pt por la revisión de los tutores** · **v1.7 del 2026-09-17: set 47 «Diálogo de confirmación · móvil» en L08** · Insumos: `STYLE_TILE.md`, `Wireframes_Alarmas_QR.html`, prototipos publicados (Figma), `FUNCIONALIDADES.md`.
...
|---|---|---|
| Regla del amarillo | Acción principal + marca; el switch activo también era amarillo | **Acento estricto:** un solo elemento amarillo por pantalla (botón primario o FAB extendido). Switch activo, píldora de pestaña activa, chip «Nueva» y numerales de pasos van en **Tinta** (comp. 10, 13, 19). **Excepción de marca (v1.14):** el logotipo — el cuadro amarillo de 32 con el módulo QR en Tinta — conserva el amarillo aunque la pantalla ya tenga su acción principal amarilla, tanto en la barra superior web como en las pantallas de acceso. La regla cuenta **acciones**, no la identidad: el logotipo no compite por el clic porque no es un control. |
...
| Hora en tarjeta | Spline Sans Mono Bold 34 + am/pm 18 | **Spline Sans Mono Bold 26–28 + am/pm Medium 12–14** en la misma línea, seguida de título Archivo Bold 15, «evento h:mm · lugar» 13 Gris Texto y chip debajo (una sola anatomía en lista, calendario, hoja y edición) (34 no cabe en 4 columnas de 390 pt). Bloques «Sonará» (M04/M09): Bold 52 con etiqueta 12 pt encima. Alarma sonando: Bold 96 + pm 28. **En la implementación esos dos tamaños piden peso 900** (v1.12, ver §5): es la forma de obtener en Android el trazo que el marco muestra en Bold. |
...
## 7 · Componentes web en los mockups (v1.3 → v1.5, 2026-09-14 / 2026-09-19)

Los mockups de la aplicación web (página `03 · Web`, 24 marcos de 1280×820 desde la web v1.5) concretan los componentes «w» del catálogo. Medidas tomadas sobre los marcos tras aplicar la revisión web v1.1 (`MOCKUPS.md` §7.4). Las divergencias detectadas en la v1.3 (botones web de 39–44 pt frente a 48 en móvil; radio 16 en modales, tarjetas de W06 y tarjeta de acceso) se resolvieron en la v1.5: **botones web a 44 pt** en todas las pantallas (regla 48 móvil / 44 web; desde la v1.6 el móvil sube a 52) y **radio 14** en todos los contenedores, en los mockups y en las láminas L07 y L09.
...
| Barra lateral | 208 de ancho, relleno 20/12, separación 4, borde derecho Gris Borde. Primer hijo: control «colapsar menú» (36×36, icono doble chevrón de 20, alineado a la derecha). Ítems de 38 pt de ancho completo (184): **icono de línea de 20 pt** + texto Archivo SemiBold 14.5, relleno 9/16, separación 10; **activo** = píldora Tinta con texto e icono blancos; **inactivo** = sin relleno, texto e icono Tinta. **Colapsada** (v1.8): 64 de ancho, solo iconos en píldoras de 40×40 centradas y el control rotado 180° («expandir menú»). «Cerrar Sesión» anclado abajo con un espaciador flexible. Las píldoras activas van en Tinta, no en amarillo (regla del acento estricto). | 14w |
| Área de contenido | 1072 de ancho, relleno 28/32, separación vertical 18 entre bloques. | — |
| Velo de modal | Capa absoluta sobre el área de contenido (1280×756) en Tinta al 45 %, con el modal centrado en ambos ejes. Desde la web v1.5 solo lo usa «Eliminar cuenta»; el diálogo «¿Cerrar sesión?» usa el velo de 55 % del patrón móvil sobre la pantalla completa. Reportes y Descargar QR ya no son modales. | 27 |
| Sección con tarjeta de formulario (W04 · W05) | Web v1.5: miga «‹ Mis alarmas / …» (marco de 27 pt, → W01), título Bricolage Grotesque Bold 24 + subtítulo Archivo Regular 14 Gris Texto, y una fila con la **tarjeta del formulario** (600 de ancho, relleno 24–26, borde Gris Borde 1.5, radio 14; conserva el contenido del antiguo modal) y una **tarjeta lateral** en FILL («Reportes generados»: título SemiBold 14.5, filas de 12/0 con nombre de archivo 14, metadatos 12.5 Gris Texto y enlace «Descargar de nuevo»; o la «Vista previa del afiche»). El ítem de la barra lateral correspondiente va activo. | — |
...
| Campo de búsqueda | 240×40 (W03: 260×40), lupa de 16 pt a la izquierda y un solo marcador «Buscar por nombre» / «Buscar asistente» (v1.3, tutores). **Activo** (web v1.5): contorno Tinta 1.5 y texto escrito en Tinta con cursor («Sem|», «Mi|»); la tabla filtra y el pie muestra «Mostrando 1 alarma · filtro: “Sem”» con el enlace «Limpiar». | 7 |
| Estado vacío de tabla | Web v1.5 (W01 · Borradores): bloque Gris Niebla de ancho completo, radio 12, relleno 16/24, centrado: título Archivo SemiBold 16 «Sin resultados con estos filtros», explicación Archivo Regular 14 Gris Texto y botón secundario «Ver todos» de 44 pt. | — |
| Paginador | Pie de tabla «Mostrando 1–4 de 16 asistentes · 4 por página» + píldoras de 30×30 (‹ 1 2 3 4 ›) Archivo SemiBold 13: activa en Tinta con texto blanco, inactivas blancas con contorno Gris Borde (v1.3); desde la web v1.5 «2» y «›» navegan a la página 2 y «1» / «‹» vuelven. | — |
...
| Componente | Especificación | Catálogo |
|---|---|---|
| Botón primario web | Píldora Amarillo Energía, texto Tinta Archivo SemiBold 14–15, **relleno horizontal 24** (v1.8, antes 18), **44 pt de alto en toda la web** (v1.5: cabecera de página, modales, W06 y tarjeta de acceso; antes 39/42/44). Regla: 52 para toque en móvil (v1.6; antes 48), 44 para puntero en web, ambas en la escala 44/52/56. Un solo primario por pantalla: en W01 «Exportar reporte»; «Descargar QR en lote» va en contorno. | 1 |
...
| Switch | 42×24, píldora Tinta con perilla blanca a la derecha cuando está activo (misma regla que el móvil). **Apagado (v1.14): píldora blanca con contorno Tinta 1.5 y perilla Tinta a la izquierda**, no un relleno Gris Borde — un gris uniforme se lee como «deshabilitado» y no como «apagado», que es un estado que el usuario sí puede cambiar. Los marcos web solo dibujan el estado activo, así que el apagado vive en el componente y en el código. | 10 |
...
| Tarjeta de acceso (W00) | **520 de ancho** (v1.13: medida real del marco `4072:1861` desde la web v1.3; la fila decía 400, que era la medida de la v1.2), relleno 34, separación 20, borde Gris Borde 1.5, radio 14 (v1.5; antes 16), centrada; marca arriba, subtítulo Archivo Regular 14 Gris Texto, campos, primario a ancho completo y nota de 13 pt. | — |
| Diálogo modal | **481 de ancho** (v1.13: medida real del marco `4072:256`; la fila decía 540–600), relleno 22, separación 16–18, radio 14 (v1.5; antes 16, también en las variantes del comp. 27 de L07), sobre el velo Tinta 45 %. **Sin fila de cabecera** en la única variante que queda: «Eliminar cuenta» (W06) se cierra con «Conservar mi cuenta», con Escape o con el velo, no con miga + «✕» (v1.13; la regla general de que la fila de cabecera completa es el control de cierre sigue valiendo para cualquier modal que sí la tenga). Título Bricolage Grotesque Bold **18**; acciones alineadas a la derecha. Desde la web v1.5 solo queda la variante destructiva «Eliminar cuenta» (W06) con icono de advertencia coral y lista de consecuencias; Reportes y Descargar QR pasaron a secciones. | 27 |
| Diálogo de confirmación web («¿Cerrar sesión?») | Web v1.5: pantalla de origen atenuada + velo Tinta 55 % (cierra), diálogo centrado de 420 de ancho, relleno 24, radio 14, sombra suave; título Bricolage Grotesque SemiBold 22, cuerpo Archivo Regular 14 / 140 % Gris Texto con la consecuencia, dos botones de 44 pt apilados: la acción segura «Cancelar» es el primario amarillo (→ W01) y «Cerrar sesión» va en contorno Tinta 1.5 (→ W00). Versión web del set 47. | 47 |
| Campo con error | Web v1.5 (W00): contorno Coral Texto 1.5 y, bajo el grupo de campos, mensaje Archivo Regular 12.5 Coral Texto «Correo o contraseña incorrectos. Inténtalo de nuevo o recupera tu contraseña.». | 6 |
| Enlace en línea | Archivo Regular 14 Azul Texto subrayado, siempre dentro de un marco propio con la conexión («Limpiar», «Descargar de nuevo»); en la tarjeta de acceso va en un marco de 44 pt a ancho completo («¿Olvidaste tu contraseña?», «‹ Volver a iniciar sesión»). | 4 |
...
- **2026-09-24 · v1.14 (solo documento)** — Dos estados que el sistema usaba pero no tenía escritos, detectados al maquetar la web. **Switch apagado:** píldora blanca con contorno Tinta 1.5 y perilla Tinta a la izquierda; los marcos web solo dibujan el estado activo (los seis switches de W06 están encendidos), así que el apagado nunca se había fijado y un relleno gris se habría leído como deshabilitado. **Excepción de marca en la regla del amarillo:** el logotipo conserva su cuadro amarillo aunque la pantalla ya tenga su acción principal amarilla, porque la regla cuenta acciones y el logotipo no es un control.

- **2026-09-24 · v1.13 (solo documento)** — Medidas web que el documento nunca reflejó, detectadas al maquetar el Plan 3 contra los marcos: la **tarjeta de acceso** de W00 mide **520**, no 400 (lo es desde la web v1.3), y el **diálogo modal** mide **481** con título 18 y **sin fila de cabecera**, no 540–600 con miga + «✕» y título 21 — desde la web v1.5 su única variante es «Eliminar cuenta», que se cierra con «Conservar mi cuenta», Escape o el velo. También quedan anotadas dos decisiones de la maquetación que se apartan del marco a propósito, por regla del propio sistema: los **campos** van a 48 con etiqueta 12 (el marco mide 46/11, pero nada baja de 12) y el **estado apagado del switch** se dibuja en contorno Tinta 1.5, no en Gris Borde, para que el apagado no se lea como deshabilitado. `MOCKUPS.md` §9 tiene la lista completa de ajustes pendientes en los marcos.

- **2026-09-24 · v1.12 (solo documento)** — Peso de las horas grandes en la implementación. A 52 y 96 pt, el Bold de «Datos» (Spline Sans Mono) se ve en Android más delgado que en el marco de Figma. Al pedir un peso que la familia **no tiene**, Android sintetiza trazo extra sobre el Bold real en vez de limitarse a escogerlo, y el resultado sí coincide con M09 y M10; por eso `font.scale.hora-protagonista` y `font.scale.hora-sonara` pasan a **weight 900** en `handoff/design-tokens.json` v1.20. **Los marcos de Figma no cambian y siguen en Bold:** la familia publicada en el archivo solo trae Light, Regular, Medium, SemiBold y Bold (verificado con `listAvailableFontsAsync`), así que 900 es un valor de implementación, no un estilo que se pueda seleccionar en el diseño. La hora en tarjeta (26) y su am/pm (12) se quedan en 700 y 500, porque a ese tamaño el Bold real ya coincide. Detectado al maquetar M09 y M10 (`NAVEGACION.md` §7).
